          ...
          <div className="flex items-center justify-start">
            ...
            {task?.surge && (
              <div className="flex my-4 rounded-[5px] bg-[#F4F5F6] p-1 justify-center items-center w-auto ml-3">
                ...
                <span className="mx-1 text-[#777E90]">{task.surge}</span>
              </div>
            )}
          </div>
          {task?.caurosal && (
            <div className="h-[90px] w-full rounded-[4px] bg-[#353945] flex items-center justify-center mb-3">
              <img
                src={imageF}
                alt="imageField"
